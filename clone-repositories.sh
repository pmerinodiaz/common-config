...
if [[ $gitusername != "" && $username != "" ]]; then
    ...
    if [ ! -d "$config" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/config.git
    else
        cd $config
        git checkout master
        git pull
    ...
    if [ ! -d "$ecourse" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/ecourse.git
    else
        cd $ecourse
        git checkout master
        git pull
    ...
    if [ ! -d "$ef" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/ef.git
    else
        cd $ef
        git checkout master
        git pull
    ...
    if [ ! -d "$emac" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/emac.git
    else
        cd $emac
        git checkout master
        git pull
    ...
    if [ ! -d "$enrichment" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/enrichment.git
    else
        cd $enrichment
        git checkout master
        git pull
    ...
    if [ ! -d "$http_poller_producer" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/http-poller-producer.git
    else
    ...
    if [ ! -d "$index_builder" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/index-builder.git
    else
        cd $index_builder
        git checkout master
        git pull
    ...
    if [ ! -d "$index_test_cases" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/index-test-cases.git
    else
        cd $index_test_cases
        git checkout master
        git pull
    ...
    if [ ! -d "$qa_load_testing" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/qa-load-testing.git
    else
        cd $qa_load_testing
        git checkout master
        git pull
    ...
    if [ ! -d "$qa_snapshots" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/qa-snapshots.git
    else
        cd $qa_snapshots
        git checkout master
        git pull
    ...
    if [ ! -d "$qa_testing_framework" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/qa-testing-framework.git
    else
    ...
    if [ ! -d "$qa_testing_framework_ci" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/qa-testing-framework-ci.git
    else
    ...
    if [ ! -d "$stats" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/stats.git
    else
        cd $stats
        git checkout master
        git pull
    ...
    if [ ! -d "$stream_snapshot" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/stream-snapshot.git
    else
        cd $stream_snapshot
        git checkout master
        git pull
    ...
    if [ ! -d "$twiki" ]; then
        cd $TRQ_FUNDACION
        git clone https://$gitusername@gitlab.com/trq-fundacion/twiki.git
    else
        cd $twiki
        git checkout master
        git pull
